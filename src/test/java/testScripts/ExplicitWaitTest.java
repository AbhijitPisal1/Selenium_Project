...
//	  wait.until(ExpectedConditions.visibilityOf(driver.findElement(By.cssSelector("div#content > p"))));
		...
		// allows one to wait for a specific condition to be met with a custom frequency
		// of checking the condition.
		// Fluent Wait looks for a web element repeatedly at regular intervals until
		// timeout happens or until the object is found
