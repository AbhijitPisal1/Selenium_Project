...
public class LambdaTestPage {
	...
	public void lambdatest() {
		...
		// // single / anchor tag will give direct child element but if we use // then
		// it will give all child elements matching the anchor tag
		Email.isDisplayed();
		...
		driver.findElement(By.xpath("//ul[@id='menu-side-menu']//li[starts-with(@id, 'menu-item')]")).isEnabled(); // syntax
																													// :
																													// //TagName[starts-with(@attrName,
																													// 'AttrValue')]

		driver.findElement(
				By.xpath("//div[@class='sidebar-inner']//descendant::div[@class='menu-side-menu-container']"))
				.isEnabled();
